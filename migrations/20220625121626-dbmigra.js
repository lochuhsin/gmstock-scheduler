...
exports.up = function (db, callback) {
  async.series(
    [
      ...
      db.createTable.bind(db, 'stocksdata', {
        symbol: { type: 'string', primaryKey: true },
        datetime: { type: 'string', primaryKey: true },
        open: { type: 'string' },
        high: { type: 'string' },
        low: { type: 'string' },
        close: { type: 'string' },
      ...
      db.createTable.bind(db, 'forexpairdata', {
        symbol: { type: 'string', primaryKey: true },
        datetime: { type: 'string', primaryKey: true },
        open: { type: 'string' },
        high: { type: 'string' },
      ...
      db.createTable.bind(db, 'cryptocurrencydata', {
        symbol: { type: 'string', primaryKey: true },
        datetime: { type: 'string', primaryKey: true },
        open: { type: 'string' },
        high: { type: 'string' },
      ...
      db.createTable.bind(db, 'etfdata', {
        symbol: { type: 'string', primaryKey: true },
        datetime: { type: 'string', primaryKey: true },
        open: { type: 'string' },
        high: { type: 'string' },
      ...
      db.createTable.bind(db, 'indicesdata', {
        symbol: { type: 'string', primaryKey: true },
        datetime: { type: 'string', primaryKey: true },
        open: { type: 'string' },
        high: { type: 'string' },
